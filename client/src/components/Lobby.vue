<template>
  <div class="flex flex-col items-center justify-center min-h-screen gap-10 p-6 relative overflow-hidden bg-[radial-gradient(circle_at_center,rgba(245,158,11,0.05)_0%,transparent_70%)]">
    ...
    <div v-if="!store.game" class="flex flex-col gap-6 w-full max-w-md p-10 bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.5)] border border-slate-800 relative group overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700">
    ...
    <div v-else class="flex flex-col items-center gap-8 w-full max-w-md p-10 bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.5)] border border-slate-800 animate-in fade-in zoom-in duration-500">
      <div class="text-center relative">
        <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em] mb-3">Chamber Access Code</p>
        <div class="bg-slate-950 px-8 py-3 rounded-2xl border border-amber-500/20 shadow-inner">
